...
{
    public class Encrypted : IEncryption
    {
        private char getMetaValue(char data)
        {
        ...
        public string EncryptASCII(string strText)
        {
        ...
        public string DecryptASCII(string strText)
        {
